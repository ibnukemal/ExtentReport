...
public class StepDefinition {
	...
	@Autowired
	com.demo.testing.utils.ConfigProperties configProperties;
	
	@Before
	public void initializeObjects() {
		com.demo.testing.driver.DriverSingleton.getInstance(configProperties.getBrowser());
	...
	public void User_go_to_the_Website() {
		...
		extentTest.log(LogStatus.PASS, "Navigate to " +Constants.URL);
	}
